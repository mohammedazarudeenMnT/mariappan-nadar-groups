...
export function ConstructionHeroImageGrid() {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 py-24 overflow-hidden bg-background">
      <ModernGridBg />
        ...
        <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-2">
          ...
          <div className="flex gap-6 flex-col">
            ...
            <div className="flex gap-4 flex-col">
              <h1 className="text-5xl md:text-6xl lg:text-7xl max-w-2xl tracking-tight text-left font-bold text-primary-200">
                Premium Construction Materials
              </h1>
              <p className="text-xl leading-relaxed tracking-tight text-white max-w-xl text-left">
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-primary-800/30">
              <div>
                <div className="text-3xl font-bold text-primary-300">100+</div>
                <div className="text-sm text-primary-400/70">Years Legacy</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary-300">500+</div>
                <div className="text-sm text-primary-400/70">Projects</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-primary-300">100%</div>
                <div className="text-sm text-primary-400/70">Quality</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="rounded-xl aspect-square overflow-hidden shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] duration-300 group">
              <div className="relative w-full h-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <div className="text-2xl font-bold">Cement</div>
                  <div className="text-sm opacity-90">Premium Quality</div>
                </div>
              </div>
            </div>

            {/* Top Right - Steel (Tall) */}
            <div className="rounded-xl row-span-2 overflow-hidden shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] duration-300 group">
              <div className="relative w-full h-full">
                <Image
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  <div className="text-3xl font-bold">Steel & Metal</div>
                  <div className="text-sm opacity-90">Industrial Grade</div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-xl aspect-square overflow-hidden shadow-xl hover:shadow-2xl transition-all hover:scale-[1.02] duration-300 group">
              <div className="relative w-full h-full">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <div className="text-sm opacity-90">Durable & Strong</div>
                </div>
              </div>
            </div>
          </div>
