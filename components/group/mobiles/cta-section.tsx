...
export function MobilesCTASection() {
  return (
    <LampContainer>
      <div className="text-center w-full max-w-6xl mx-auto px-4">
        ...
        >
          Shop the Latest Smartphones with Mathi Mobiles
        </motion.p>
        ...
        >
          Discover offers, browse collections, and connect with us directly
          online
        </motion.p>
        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group inline-flex items-center gap-3 px-6 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-xl font-bold text-base sm:text-lg shadow-2xl hover:shadow-cyan-500/50 transition-all cursor-pointer"
            >
              Visit Mathi Mobiles Website
              <motion.div
                animate={{ x: [0, 5, 0] }}
