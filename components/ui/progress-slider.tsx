...
export const ProgressSlider: FC<ProgressSliderProps> = ({
  ...
  useEffect(() => {
    ...
    if (
      getChildren &&
      typeof getChildren === "object" &&
      "props" in getChildren
    ) {
      const element = getChildren as React.ReactElement<{
        children: React.ReactNode;
      }>;
      const values = React.Children.toArray(element.props.children).map(
