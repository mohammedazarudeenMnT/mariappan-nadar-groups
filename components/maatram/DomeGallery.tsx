      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage: `radial-gradient(circle at center, transparent 60%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`,
            }}
          />
          ...
          <div
            className="absolute inset-0 m-auto z-[3] pointer-events-none"
            style={{
              WebkitMaskImage: `radial-gradient(circle at center, transparent 65%, black 95%)`,
              maskImage: `radial-gradient(circle at center, transparent 65%, black 95%)`,
              backdropFilter: "blur(1px)",
            }}
          />

          <div
            className="absolute left-0 right-0 top-0 h-[80px] z-[5] pointer-events-none rotate-180"
            style={{
              background: `linear-gradient(to bottom, transparent 0%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`,
            }}
          />
          <div
            className="absolute left-0 right-0 bottom-0 h-[80px] z-[5] pointer-events-none"
            style={{
              background: `linear-gradient(to bottom, transparent 0%, var(--overlay-blur-color, ${overlayBlurColor}) 100%)`,
            }}
          />
